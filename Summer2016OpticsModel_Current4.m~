...
remoteSensingReflectance = [inputMatrix(3,waterLeavingRadianceLocation)/inputMatrix(3,downwellingIrradianceLocation),inputMatrix(4,waterLeavingRadianceLocation)/inputMatrix(4,downwellingIrradianceLocation)] %440/550
a_coeff=[.3255,-2.7677,2.4409,-1.1288,-.499]
log_10_chla= a_coeff(1)+a_coeff(2)*log10(remoteSensingReflectance(1)/remoteSensingReflectance(2))^1+a_coeff(3)*log10(remoteSensingReflectance(1)/remoteSensingReflectance(2))^2+a_coeff(4)*log10(remoteSensingReflectance(1)/remoteSensingReflectance(2))^3+a_coeff(5)*log10(remoteSensingReflectance(1)/remoteSensingReflectance(2))^4
chl_a_concentration = 10^(log_10_chla) %mg/m^3 or ug/L
outputCell{calculatedConcentration_OC4Loc,4} = chl_a_concentration;

remoteSensingReflectance = [inputMatrix(5,waterLeavingRadianceLocation)/inputMatrix(5,downwellingIrradianceLocation),inputMatrix(6,waterLeavingRadianceLocation)/inputMatrix(6,downwellingIrradianceLocation)]
a_coeff=[.3255,-2.7677,2.4409,-1.1288,-.499]
log_10_chla= a_coeff(1)+a_coeff(2)*log10(remoteSensingReflectance(1)/remoteSensingReflectance(2))^1+a_coeff(3)*log10(remoteSensingReflectance(1)/remoteSensingReflectance(2))^2+a_coeff(4)*log10(remoteSensingReflectance(1)/remoteSensingReflectance(2))^3+a_coeff(5)*log10(remoteSensingReflectance(1)/remoteSensingReflectance(2))^4
chl_a_concentration = 10^(log_10_chla) %mg/m^3 or ug/L
outputCell{calculatedConcentration_OC4Loc,6} = chl_a_concentration;

remoteSensingReflectance = [inputMatrix(7,waterLeavingRadianceLocation)/inputMatrix(7,downwellingIrradianceLocation),inputMatrix(8,waterLeavingRadianceLocation)/inputMatrix(8,downwellingIrradianceLocation)]
a_coeff=[.3255,-2.7677,2.4409,-1.1288,-.499]
log_10_chla= a_coeff(1)+a_coeff(2)*log10(remoteSensingReflectance(1)/remoteSensingReflectance(2))^1+a_coeff(3)*log10(remoteSensingReflectance(1)/remoteSensingReflectance(2))^2+a_coeff(4)*log10(remoteSensingReflectance(1)/remoteSensingReflectance(2))^3+a_coeff(5)*log10(remoteSensingReflectance(1)/remoteSensingReflectance(2))^4
chl_a_concentration = 10^(log_10_chla) %mg/m^3 or ug/L
outputCell{calculatedConcentration_OC4Loc,8} = chl_a_concentration;

remoteSensingReflectance = [inputMatrix(9,waterLeavingRadianceLocation)/inputMatrix(9,downwellingIrradianceLocation),inputMatrix(10,waterLeavingRadianceLocation)/inputMatrix(10,downwellingIrradianceLocation)]
a_coeff=[.3255,-2.7677,2.4409,-1.1288,-.499]
log_10_chla= a_coeff(1)+a_coeff(2)*log10(remoteSensingReflectance(1)/remoteSensingReflectance(2))^1+a_coeff(3)*log10(remoteSensingReflectance(1)/remoteSensingReflectance(2))^2+a_coeff(4)*log10(remoteSensingReflectance(1)/remoteSensingReflectance(2))^3+a_coeff(5)*log10(remoteSensingReflectance(1)/remoteSensingReflectance(2))^4
chl_a_concentration = 10^(log_10_chla) %mg/m^3 or ug/L
outputCell{calculatedConcentration_OC4Loc,10} = chl_a_concentration;

remoteSensingReflectance = [inputMatrix(11,waterLeavingRadianceLocation)/inputMatrix(11,downwellingIrradianceLocation),inputMatrix(12,waterLeavingRadianceLocation)/inputMatrix(12,downwellingIrradianceLocation)]
a_coeff=[.3255,-2.7677,2.4409,-1.1288,-.499]
log_10_chla= a_coeff(1)+a_coeff(2)*log10(remoteSensingReflectance(1)/remoteSensingReflectance(2))^1+a_coeff(3)*log10(remoteSensingReflectance(1)/remoteSensingReflectance(2))^2+a_coeff(4)*log10(remoteSensingReflectance(1)/remoteSensingReflectance(2))^3+a_coeff(5)*log10(remoteSensingReflectance(1)/remoteSensingReflectance(2))^4
chl_a_concentration = 10^(log_10_chla) %mg/m^3 or ug/L
